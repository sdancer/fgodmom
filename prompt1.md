we are writting an emulator for a specific DOS game
currently it runs up to the first INT 10
lets make the int handlers stop whenever something is not implemented
and add VGA handling
the final goal is that the game runs via unicorn on modern linux
...
```
[*] Calculated final JMPF hook address: 0x40ab5
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
...
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x35. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x25. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x25. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x25. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x25. Continuing emulation.
[*] Unhandled INT 21h function: AH=0x44. Continuing emulation.
[*] Unhandled interrupt: 0x10. Stopping emulation.
```
